...
if __name__=="__main__":
    ...
    csv_files = glob.glob(path_to_directory + '.pkl')
       ...
       #create electorni 
    test_ehr_dataset,train_ehr_dataset,synthetic_ehr_dataset,features  = load_create_ehr(read_ehr,save_ehr,file_path_dataset,sample_patients_path,file,valid_perc,features_path)
    
       #constrains  
    train_ehr_dataset,synthetic_ehr_dataset,test_ehr_dataset = make_read_constraints(make_contrains,save_constrains,train_ehr_dataset,test_ehr_dataset,synthetic_ehr_dataset)
    ...
    list_metric_resemblance = [
       ##descriptive stadistics
        ...
        #"get_top10_different_proportion",         #identificar la frecuencia por alrbol y hoja/ identidicar mas comumnes pro arbol y hoja
